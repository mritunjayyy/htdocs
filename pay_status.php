    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 my-5 mb-5 px-4">
                <h2 class="fw-bold fs-1">PAYMENT STATUS</h2>
            </div>
            ...
            if($booking_fetch['trans_status']=="TXN_SUCCESS"){
                echo <<< data
                    <div class="col-12 fs-2 px-4">
                        <p class="fw-bold alert alert-success p-5 mb-5">
                            <i class="bi bi-check-circle-fill"></i>
                            Payment done! Booking successful.
                            <br><br>
                            <a href='bookings.php'>click here to Go to Your Bookings</a>
                        </p>
                    </div>
                data;
            } else {
                echo <<< data
                    <div class="col-12 px-4">
                        <p class="fw-bold alert alert-danger">
                            <i class="bi bi-check-exclamation-fill"></i>
